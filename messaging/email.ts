...
export const sendSignupCompleteProfileEmail = (to:string, id:string, firstName:string) => {
  transporter.sendMail({
    from: process.env.GMAIL_SMTP_EMAIL,
    to,
...
export const sendResetPasswordEmail = async (to:string, token:string, firstName:string) => {
